  ...
  <header class="mb-8">
    ...
    <UCard>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <UFormField :label="t.header.firstName">
          <UInput
            v-model="formData.studentFirstName"
            :placeholder="t.header.firstNamePlaceholder"
            class="w-full"
            autocomplete="given-name"
          />
        </UFormField>
        <UFormField :label="t.header.date">
          <UInput
      ...
      <UFormField
        :label="t.maquettes.projectName"
        class="mt-4"
      >
        <UInput
          v-model="formData.projectName"
          :placeholder="t.maquettes.projectNamePlaceholder"
          class="w-full"
        />
      </UFormField>
    </UCard>
